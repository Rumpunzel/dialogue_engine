...
static func vector_add_arrays(arrays: Array) -> Array:
	var return_array = []
...
static func vector_add_dictionaries(dictionaries: Array) -> Dictionary:
...
static func calculate_loop_modulo(index: int, array_size: int, loop_from: int) -> int:
...
static func get_unique_values_in_array(array: Array, stepify_value = 0) -> int:
	var unique_points = 0
...
static func generate_array(length, content) -> Array:
	var array: Array = [ ]
...
static func get_array_from(array: Array, index: int) -> Array:
