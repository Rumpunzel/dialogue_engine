class_name DialogueCharacter, "res://dialogue_engine/assets/icons/icon_dialogue_character.svg"
extends Node
...
export(String, FILE, "*.char") var json_path = ""
# The path to the .convo file of the (default) conversation for this character
export(String, FILE, "*.convo") var conversation_path


onready var id: String = name
onready var memories: CharacterMemories = $memories
# Default perception characters will have of this character without ever metting them (basically reputations)
var percieved_starting_values: Dictionary setget set_percieved_starting_values
